...
//			core.setScopeTempVar(node.$scope, tempVar);
	 ...
	 * */
	, declarationContainsDeclarator: function(declarationNode, declaratorNode) {;var $that$0=this;
		...
		var k = 0, len = declarations.length;
		for(  ; k < len ; k++ ) {;var $retPrim$0;var $value$0 = (function(){
			declaration = declarations[k];

			if( $that$0.is.isObjectPattern(declaration) || $that$0.is.isArrayPattern(declaration) ) {
				var result;
				$that$0.traverseDestructuringVariables(declaration, function(declaration) {
	...
	, hasNodeBetween: function(fromNode, toNode) {
		var node = fromNode;
		var result = false;
		var findNodes = [].slice.call(arguments, 2);
